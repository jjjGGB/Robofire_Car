...
def generate_launch_description():
    ...
    declare_rviz_software_rendering_cmd = DeclareLaunchArgument(
        "rviz_software_rendering",
        default_value="true",
        description="Whether to force software rendering for RViz2 to avoid GLSL driver issues",
    )
    ...
    ld.add_action(declare_rviz_software_rendering_cmd)
