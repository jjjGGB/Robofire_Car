...
def generate_launch_description():
    ...
    get_package_share_directory('robot_navigation'), 'config', 'simulation', 'measurement_params_sim.yaml')))
    robot_description = Command(['xacro ', os.path.join(
    get_package_share_directory('robot_navigation'), 'urdf', 'sentry_robot_sim.xacro'),
