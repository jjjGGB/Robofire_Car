...
def generate_launch_description():
    ...
    get_package_share_directory('robot_navigation'), 'config', 'reality', 'measurement_params_real.yaml')))
    robot_description = Command(['xacro ', os.path.join(
    get_package_share_directory('robot_navigation'), 'urdf', 'sentry_robot_real.xacro'),
    ...
    fastlio_mid360_params = os.path.join(robot_navigation_dir, 'config', 'reality', 'fastlio_mid360_real.yaml')
    ...
    pointlio_mid360_params = os.path.join(robot_navigation_dir, 'config', 'reality', 'pointlio_mid360_real.yaml')
    ...
    slam_toolbox_localization_file_dir = os.path.join(robot_navigation_dir, 'config', 'reality', 'mapper_params_localization_real.yaml')
    slam_toolbox_mapping_file_dir = os.path.join(robot_navigation_dir, 'config', 'reality', 'mapper_params_online_async_real.yaml')
    ################################### slam_toolbox parameters end ###################################

    ################################### navigation2 parameters start ##################################
    nav2_map_dir = PathJoinSubstitution([robot_navigation_dir, 'map', world]), ".yaml"
    nav2_params_file_dir = os.path.join(robot_navigation_dir, 'config', 'reality', 'nav2_params_real.yaml')
    ################################### navigation2 parameters end ####################################

    ################################ icp_registration parameters start ################################
    icp_pcd_dir = PathJoinSubstitution([robot_navigation_dir, 'PCD', world]), ".pcd"
    ...
    pointcloud_downsampling_config_dir = os.path.join(robot_navigation_dir, 'config', 'reality', 'pointcloud_downsampling_real.yaml')
    ############################# pointcloud_downsampling parameters start ############################
